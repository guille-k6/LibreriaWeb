...
public class ABMEjemplaresForm extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(opc!=null){
			...
			//Busco el ejemplar con ese ID y lo mando como par�metro al autor a la p�gina de modificar.
			...
			//Busco el ejemplar con ese ID y lo mando como par�metro al autor a la p�gina de eliminar.
